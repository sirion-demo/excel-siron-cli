...
const currency = () => (d) => { return API_VER === 'v2' ? { id: currencyIdV2.find(c => c.name === d)?.id } : { externalId: d } }
...
// update field mappings with sirion clt id, template field names and excel column names with transform as needed
const fieldMappings = []
